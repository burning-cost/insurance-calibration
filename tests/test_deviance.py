...
class TestPoissonDeviance:
    ...
    def test_exposure_weighting(self):
        ...
        # Heavier weight on first obs (y=0.1, mu=0.2) vs second (y=0.3, mu=0.2)
        # First unit deviance > second (underprediction further from 0), so heavy
        # on first should give higher deviance
...
class TestTweedieDeviance:
    def test_perfect_prediction_approx_zero(self):
        ...
        # Not exactly zero because y=0 uses eps approximation
        assert result >= 0
